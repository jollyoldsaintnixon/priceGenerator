    ...
    render() {
        ...
        return (
            <div className="slide slide-vehicle">
                <p className="slide-headline">Alright, {convertToWord(selectedAmount)} {makePlural(selectedVehicle, selectedAmount)}. How would you like to measure your reservation- by days, hours or miles?</p>
